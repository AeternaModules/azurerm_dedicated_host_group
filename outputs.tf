output "dedicated_host_groups_id" {
  ...
  value       = { for k, v in azurerm_dedicated_host_group.dedicated_host_groups : k => v.id if v.id != null && length(v.id) > 0 }
}
output "dedicated_host_groups_automatic_placement_enabled" {
  ...
  value       = { for k, v in azurerm_dedicated_host_group.dedicated_host_groups : k => v.automatic_placement_enabled if v.automatic_placement_enabled != null }
}
output "dedicated_host_groups_location" {
  ...
  value       = { for k, v in azurerm_dedicated_host_group.dedicated_host_groups : k => v.location if v.location != null && length(v.location) > 0 }
}
output "dedicated_host_groups_name" {
  ...
  value       = { for k, v in azurerm_dedicated_host_group.dedicated_host_groups : k => v.name if v.name != null && length(v.name) > 0 }
}
output "dedicated_host_groups_platform_fault_domain_count" {
  ...
  value       = { for k, v in azurerm_dedicated_host_group.dedicated_host_groups : k => v.platform_fault_domain_count if v.platform_fault_domain_count != null }
}
output "dedicated_host_groups_resource_group_name" {
  ...
  value       = { for k, v in azurerm_dedicated_host_group.dedicated_host_groups : k => v.resource_group_name if v.resource_group_name != null && length(v.resource_group_name) > 0 }
}
output "dedicated_host_groups_tags" {
  ...
  value       = { for k, v in azurerm_dedicated_host_group.dedicated_host_groups : k => v.tags if v.tags != null && length(v.tags) > 0 }
}
output "dedicated_host_groups_zone" {
  ...
  value       = { for k, v in azurerm_dedicated_host_group.dedicated_host_groups : k => v.zone if v.zone != null && length(v.zone) > 0 }
}
